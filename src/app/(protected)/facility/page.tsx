  ...
  return (
    <>
      ...
      <div className="mt-[30px] rounded-md border px-5 py-7">
        {/* TODO: 아이콘 변경하기 */}
        <SelectBox className="select-checkin" options={['Check-in', 'Security']} />
      </div>
      ...
      <AppTabs className="mt-[30px]" tabs={TAB_MENUS}>
        ...
        <TabsContent value={TAB_MENUS[0].value}>
          <div className="my-[30px] flex justify-between">
            ...
            <div className="flex items-center gap-2.5">
              ...
              >
                ...
                <MenuItem>
                  <Image src="/image/ico-download.svg" alt="" width={20} height={20} /> Download data to local
                  PC
                </MenuItem>
                <MenuItem>
          ...
          <div className="mt-10 flex justify-between">
            <dl>
              ...
              <dd className="text-sm">
                Analyze the sum of the performances of the selected Check-In facilities for each indicator. You
                can select up to two indicators.
              </dd>
            </dl>
          </div>
          ...
          <div className="my-10 flex justify-between">
            <dl>
              ...
              <dd className="text-sm">
                Visualize and display the performance of the selected Check-In facility. Color density makes it
                easy to see changes in data values and relative differences.
              </dd>
            </dl>
          </div>
        ...
        <TabsContent value={TAB_MENUS[1].value}>
          <div className="my-[30px]">hello 2</div>
        </TabsContent>
      </AppTabs>
    </>
  );
