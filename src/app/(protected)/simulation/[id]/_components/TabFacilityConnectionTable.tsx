...
export default function TabFacilityConnectionTable({
  connections,
  connectionMatrices,
  onToggleConnection,
  onUpdatePercentage,
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse select-none">
            <thead>
              <tr>
                <th className="border border-gray-200 bg-primary/5 p-3 text-center font-medium text-primary">
                  Process
                </th>
                {allDestinationNodes.map((destInfo, index) => (
                  <th
